...
from ipnet.examples.clos import clos2_30, clos3_40, clos3_80


class Clos3_80Test(TestCase):
    
    def setUp(self) -> None:
        self.net = clos3_80.setup()
    
    def test_reachability(self):
        sleep(30)
        for h_i in range(1, 33):
            h = "h{}".format(h_i)
            for h_j in range(h_i, 33):
