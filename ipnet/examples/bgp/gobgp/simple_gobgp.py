...
from ipnet import IPNetwork, FRR, IPNode, CLIX
from ipnet.examples.bgp.gobgp.node import FRRgoBGP
...
def setup() -> IPNetwork:
    ...
    # FRRouting Router
    collector = net.addFRR("collector", cls=FRRgoBGP, gobgpd_conf=str(path.joinpath("./c_gobgpd.conf")))
    r1 = net.addFRR("r1", enable_daemons=["isisd"], cls=FRRgoBGP, gobgpd_conf=str(path.joinpath("./r1_gobgpd.conf")))
    r2 = net.addFRR("r2", enable_daemons=["isisd"], cls=FRR)
    r3 = net.addFRR("r3", enable_daemons=["isisd"], cls=FRR)
    r4 = net.addFRR("r4", enable_daemons=["isisd"], cls=FRR)
    r5 = net.addFRR("r5", enable_daemons=["isisd"], cls=FRR)
    r6 = net.addFRR("r6", enable_daemons=["isisd"], cls=FRR)
    r7 = net.addFRR("r7", enable_daemons=["isisd"], cls=FRR)
    r8 = net.addFRR("r8", enable_daemons=["isisd"], cls=FRR)
    ...
    net.add_mgmt_l2network("c0", inNamespace=False, cls=FRRgoBGP, ip_base="10.10.10.{node}/24")
